...
Example of how to create an Azure Landing Zone using an existing Azure Subscription with a spoke Virtual Network connected to a Virtual WAN Hub.
...
param hubVirtualNetworkId = '/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/xxxxxxxxxxxxx/providers/Microsoft.Network/virtualHubs/xxxxxxxxxxxx' // Azure vWAN Hub resource ID
